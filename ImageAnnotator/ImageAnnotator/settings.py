"""
Django settings for ImageAnnotator project.
...
SECRET_KEY = 'psrno14^%0y0-z2p$4#7)^kvzgh1_h7ar692rpx+#giuz_*cqc'
...
ROOT_URLCONF = 'ImageAnnotator.urls'
...
WSGI_APPLICATION = 'ImageAnnotator.wsgi.application'
